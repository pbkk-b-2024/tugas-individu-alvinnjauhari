    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li class="dropdown"><a href="#!"><i class="bi bi-menu-button navicon"></i> <span>Tugas 2</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
          <ul>
            <li class="dropdown"><a href="#!"><i class="bi bi-menu-button navicon"></i> <span>CRUD Database <br>
              "Aplikasi Tiket Kereta Api"</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
                @if (Auth::check())

                <li><a href="">Tiket</a></li>
                <li><a href="">Stasiun</a></li>

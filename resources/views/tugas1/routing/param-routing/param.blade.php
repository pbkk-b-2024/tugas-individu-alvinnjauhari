...
<h1 class="judul-pages">Parameter Routing</h1>
...
{{-- <script>
    document.getElementById('form1').addEventListener('submit', function(e) {
        ...
        const url = `{{ url('/tugas1/routing/param-routing/param') }}/${param1}`;
    ...
    document.getElementById('form2').addEventListener('submit', function(e) {
        ...
        const url = `{{ url('/tugas1/routing/param-routing/param') }}/${param1}/${param2}`;
        window.location.href = url; 
    });
</script> --}}
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePreview1() {
            ...
            const previewUrl1 = `{{ url('/tugas1/routing/param-routing/param') }}/${param1}`;
        ...
        function updatePreview2() {
            ...
            const previewUrl2 = `{{ url('/tugas1/routing/param-routing/param') }}/${param1}/${param2}`;
